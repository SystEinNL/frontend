...
import data from "../../data/researchCarousel.json";
        ...
        <div className="featured-slider-2">
            <div className="featured-slider-2-items" style={{ overflow: "hidden" }}>
                <Slider asNavFor={nav2} ref={(slider1) => setNav1(slider1)}>
                    {data.slice(1, 6).map((item, i) => (
                        <div className="slider-single" key={item.id || i}>
            ...
            <div className="container position-relative">
                ...
                <div className="featured-slider-2-nav-cover">
                    ...
                    >
                        {data.slice(1, 6).map((item, i) => (
                            <div className="slider-post-thumb mr-15 mt-20 position-relative" key={item.id || i}>
